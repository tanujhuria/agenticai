        ...
        >
          ...
          <motion.div variants={columnVariants} className="relative">
            ...
            <ul className="space-y-3 text-sm">
              <li><button onClick={() => onNavigationClick('platform')} className="text-gray-600 hover:text-gray-900 transition-colors">The AgenticView Platform</button></li>
              <li><button onClick={() => onNavigationClick('about')} className="text-gray-600 hover:text-gray-900 transition-colors">Why AgenticView</button></li>
              ...
              <li><button onClick={() => onNavigationClick('about')} className="text-gray-600 hover:text-gray-900 transition-colors">AgenticView Cares</button></li>
          ...
          <motion.div variants={columnVariants} className="relative">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><button onClick={() => onNavigationClick('demo')} className="text-gray-600 hover:text-gray-900 transition-colors">AgenticView Conference</button></li>
