...
=======
          ...
          {/* Top Search Bar */}
          <section className="relative bg-white pt-3 pb-4 px-4 sm:px-6">
            <div className="mx-auto relative z-10">
              <motion.div
                initial={{ opacity: 0, y: -12 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4 }}
                className="relative w-full sm:w-[70%] mx-auto"
              >
                ...
                <input
                  ...
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-12 pr-4 py-3 text-base sm:text-lg border-2 border-purple-100 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary bg-white/90 backdrop-blur-sm shadow-sm"
                />
                {searchTerm && (
                  <button
                    onClick={() => setSearchTerm('')}
...
=======
            ...
            >
              <Card className="p-4 lg:p-6 lg:sticky lg:top-24 bg-white/80 backdrop-blur-sm border-purple-100/50">
                <h3 className="text-lg font-bold text-gray-900 mb-6">Categories</h3>
>>>>>>> e35854f (Whole new code so many changes which are not pushed)
                {/* Category Menu */}
...
=======
                <Card className="p-6 lg:p-8 h-full hover:shadow-xl transition-all duration-300 cursor-pointer group border-purple-100/50 hover:border-purple-200 bg-white/90 backdrop-blur-sm">
>>>>>>> e35854f (Whole new code so many changes which are not pushed)
