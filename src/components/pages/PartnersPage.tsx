...
import { ArrowUpRight, Calendar, Handshake, Award, Target, Users, Globe, TrendingUp, CheckCircle, Star, Building, Zap, Shield, Code } from 'lucide-react';
  ...
  const successStories = [
    {
      ...
      description: "Achieved 500% revenue growth in 18 months by specializing in Agentic View implementations for manufacturing clients.",
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl mb-6 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent font-family-headings">
              Grow Your Business with Agentic View
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {partnerTiers.map((tier, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="p-8 h-full border-purple-100/50 hover:border-purple-200 transition-all duration-300 hover:shadow-xl bg-white/80 backdrop-blur-sm text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {successStories.map((story, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="h-full overflow-hidden border-purple-100/50 hover:border-purple-200 transition-all duration-300 hover:shadow-xl bg-white/80 backdrop-blur-sm group">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed">
              Join thousands of partners worldwide who are growing their business with Agentic View. 
