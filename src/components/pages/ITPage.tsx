...
import { ArrowUpRight, Play, Calendar, Bot, Settings, Monitor, Zap } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-2xl md:text-3xl text-gray-600 mb-8 leading-relaxed">
                Smart Infrastructure. Automated Operations. Seamless Support.
              </p>
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1518709268805-4e9042af2176?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpdCUyMGRhc2hib2FyZHxlbnwxfHx8fDE3NTc5Mzg3NDB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                  alt="IT AVi Dashboard"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              IT AVi's are intelligent technology assistants that automate infrastructure management, 
              system monitoring, incident response, and user support, ensuring optimal performance 
              and reliability across your entire technology stack.
            </p>
          </motion.div>
        </div>
      </section>
